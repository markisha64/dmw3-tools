...
#[component]
pub fn PartyData(team_id: u32) -> Element {
    ...
    let party = &parties[team_id as usize];
            ...
            table {
                ...
                table {
                    ...
                    tr {
                        ...
                        td {
                            "{party_exp_bits[team_id as usize].dv_exp}"
                        }
                        td {
                            "{party_exp_bits[team_id as usize].exp}"
                        }
                        td {
                            "{party_exp_bits[team_id as usize].bits}"
                        }
                    }
                }
                table {
